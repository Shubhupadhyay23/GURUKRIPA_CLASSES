...
export default function Index() {
  ...
  const programs = [
    ...
    { name: "REET", icon: "👨‍🏫", color: "from-purple-500 to-pink-500", delay: 100 },
    { name: "1st & 2nd Grade", icon: "🎓", color: "from-green-500 to-emerald-500", delay: 200 },
    { name: "CET", icon: "🏆", color: "from-orange-500 to-red-500", delay: 300 },
    { name: "PSI", icon: "⚖️", color: "from-indigo-500 to-blue-500", delay: 400 },
  ];
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-20 left-20 w-72 h-72 bg-cyan-400 opacity-10 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }}></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#programs" className="text-gray-700 hover:text-blue-600 transition relative group">
                Programs
            ...
            <div className="flex items-center gap-3">
              <a href="tel:8619836193" className="hidden md:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105">
                <Phone size={18} />
                <span>Call Us</span>
              </a>
            </div>
      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 text-white overflow-hidden pt-20 pb-32">
        ...
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-white opacity-5 rounded-full -ml-36 -mb-36 animate-float" style={{ animationDelay: "1s" }}></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className={`space-y-4 transition-all duration-1000 ${isVisible ? "animate-fade-in-left" : "opacity-0 translate-x-8"}`}>
              ...
              <div className={`space-y-3 transition-all duration-1000 delay-200 ${isVisible ? "animate-fade-in-left" : "opacity-0 translate-x-8"}`}>
              ...
              <div className={`flex gap-4 pt-4 transition-all duration-1000 delay-300 ${isVisible ? "animate-fade-in-left" : "opacity-0 translate-x-8"}`}>
                <a href="tel:8619836193" className="inline-flex items-center gap-2 bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 hover:shadow-2xl hover:shadow-white/50 transition-all duration-300 transform hover:scale-105 active:scale-95">
                  <Phone size={20} />
                  Call Now
                </a>
                <a href="#contact" className="inline-flex items-center gap-2 border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 hover:shadow-2xl hover:shadow-blue-400/50 transition-all duration-300 transform hover:scale-105 active:scale-95">
                  Get More Info
                  <ArrowRight size={20} />
                </a>
              </div>
            ...
            <div className={`hidden md:block relative transition-all duration-1000 delay-300 ${isVisible ? "animate-fade-in-right" : "opacity-0 translate-x-12"}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className={`w-14 h-14 bg-gradient-to-br ${feature.color} rounded-xl flex items-center justify-center mb-6 group-hover:scale-125 group-hover:shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300`}>
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 rounded-3xl p-12 text-white hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105 animate-fade-in-up">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-3xl font-bold mb-4 animate-fade-in-left">Run by RAJENDRA GURJAR</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-white p-8 rounded-2xl border border-gray-200 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300 transform hover:-translate-y-2 hover:border-blue-200 group animate-fade-in-left">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:8619836193" className="text-blue-600 hover:text-blue-700 font-semibold hover:underline transition-all">
                      8619836193
                    </a>
                  </div>
                </div>
              ...
              <div className="bg-white p-8 rounded-2xl border border-gray-200 hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-300 transform hover:-translate-y-2 hover:border-cyan-200 group animate-fade-in-left" style={{ animationDelay: "100ms" }}>
                <div className="flex items-start gap-4">
              ...
              <div className="bg-white p-8 rounded-2xl border border-gray-200 hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-300 transform hover:-translate-y-2 hover:border-purple-200 group animate-fade-in-left" style={{ animationDelay: "200ms" }}>
                <div className="flex items-start gap-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 mb-4 md:mb-0 group hover:scale-105 transition-transform duration-300">
              ...
              <span className="font-bold group-hover:text-blue-400 transition-colors">GURUKRIPA CLASSES CHOMU</span>
            </div>
            <div className="text-center md:text-right">
              <p className="text-sm">© 2024 Gurukripa Classes. All rights reserved.</p>
              <p className="text-xs text-gray-400 mt-1">Dholi Mandi, Chomu | Phone: <a href="tel:8619836193" className="text-blue-400 hover:text-blue-300 transition-colors">8619836193</a></p>
            </div>
          </div>
        </div>
      </footer>
